...
// Configuration for IT Teams
const INPUT_FILE = './source-docs/API Documentation IT Teams - SuperOps.md';
const OUTPUT_BASE = './packages/it/docs';
const PRODUCT_TITLE = 'SuperOps IT Teams GraphQL API';
const ENDPOINTS = {
